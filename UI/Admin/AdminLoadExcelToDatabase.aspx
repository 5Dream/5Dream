...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="top">
        <asp:Label ID="Label1" runat="server" Text="导入教师基本信息"></asp:Label>
    </div>
    <div class="LoadExcel">
        ...
        <asp:Button ID="Button1" runat="server" Text="导入" Width="90px" />

    </div>
    <div class="top">
        <asp:Label ID="Label3" runat="server" Text="分系部导入教师信息"></asp:Label>
    </div>
    <div class="LoadExcel">

        <asp:DropDownList ID="DropDownList1" runat="server"></asp:DropDownList><br/>

        <asp:Label ID="Label4" runat="server" Text="选择要导入的文件"></asp:Label>
    ...
    <div class="top">
        <asp:Label ID="Label5" runat="server" Text="导入本学期校历"></asp:Label>
    </div>
    <div class="LoadExcel">
    ...
    <div class="top">
        <asp:Label ID="Label7" runat="server" Text="导入各系部总人数"></asp:Label>
    </div>
    <div class="LoadExcel">
        <asp:Label ID="Label8" runat="server" Text="信息与艺术设计系"></asp:Label>
        <asp:TextBox ID="TextBox1" runat="server" Width="100px"></asp:TextBox>
        <asp:Label ID="Label9" runat="server" Text="会计系"></asp:Label>
        <asp:TextBox ID="TextBox2" runat="server" Width="100px"></asp:TextBox>
        <asp:Label ID="Label10" runat="server" Text="经济管理系"></asp:Label>
        <asp:TextBox ID="TextBox3" runat="server" Width="100px"></asp:TextBox>
        <asp:Label ID="Label11" runat="server" Text="食品工程系"></asp:Label>
        <asp:TextBox ID="TextBox4" runat="server" Width="100px"></asp:TextBox><br />
        <asp:Label ID="Label12" runat="server" Text="机械工程系                  "></asp:Label>
        <asp:TextBox ID="TextBox5" runat="server" Width="100px"></asp:TextBox>
        <asp:Label ID="Label13" runat="server" Text="建筑工程系"></asp:Label>
    ...
    <div class="top">
      <asp:Label ID="Label15" runat="server" Text="数据处理"></asp:Label>
    </div>
    <div class="LoadExcel">
