  ...
  <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <style type="text/css">
      ...
      <div class="LoadExcel">
          ...
          &nbsp
          <asp:Button ID="Button1" runat="server" Text="导入" Width="90px" OnClick="Button1_Click1" BackColor="#FFCCFF" />
     ...
     &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;    &nbsp;
          <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="XmlDataSource2" DataTextField="title" DataValueField="title" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList><br/>
  
          <asp:Label ID="Label5" runat="server" Text="选择要导入的文件"></asp:Label>
  
          <asp:FileUpload ID="FileUpload2" runat="server" Width="460px" />
            &nbsp
          <asp:Button ID="Button2" runat="server" Text="导入" Width="90px" OnClick="Button2_Click" BackColor="#FFCCCC" />
      ...
      <div class="LoadExcel">
          ...
          <asp:FileUpload ID="FileUpload3" runat="server" Width="460px" />
            &nbsp
          <asp:Button ID="Button3" runat="server" Text="导入" Width="90px" BackColor="#FFCCCC" />
      ...
      <div class="LoadExcel">
          <asp:Label ID="Label9" runat="server" Text="会计系"></asp:Label>
                ...
                <asp:Label ID="Label13" runat="server" Text="机械工程系"></asp:Label>
                 &nbsp; 
                <asp:Label ID="Label14" runat="server" Text="商务外语系"></asp:Label>
                 &nbsp;
                <asp:Label ID="Label15" runat="server" Text="建筑工程系"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox1" runat="server" Width="42px"></asp:TextBox>
                ...
                <asp:TextBox ID="TextBox3" runat="server" Width="42px"></asp:TextBox>
                     &nbsp; &nbsp;
                <asp:TextBox ID="TextBox4" runat="server" Width="42px"></asp:TextBox>
                     &nbsp; &nbsp;  &nbsp; 
                <asp:TextBox ID="TextBox5" runat="server" Width="42px"></asp:TextBox>
                     &nbsp; &nbsp; &nbsp; 
                <asp:TextBox ID="TextBox6" runat="server" Width="42px"></asp:TextBox>
                     &nbsp; &nbsp; 
                <asp:TextBox ID="TextBox7" runat="server" Width="42px"></asp:TextBox>
        <br />
           &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp; &nbsp;   &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp;  
                   <asp:Button ID="Button4" runat="server" Text="确定" Width="93px"  OnClick="Button4_Click" BackColor="#FFCCCC" />
            <br />
            <br />
      ...
      <div class="LoadExcel">
          <asp:Button ID="Button5" runat="server" Text="分析入库数据" OnClick="Button5_Click" BackColor="#FFCCCC" />
          &nbsp; &nbsp; &nbsp; &nbsp; 
          <asp:Label ID="messige5" runat="server"></asp:Label>
          <br />
          <asp:Button ID="Button6" runat="server" Text="处理入库数据" OnClick="Button6_Click" BackColor="#FFCCCC" />
          &nbsp; &nbsp; 
          &nbsp; &nbsp; 
          <asp:Label ID="messige6" runat="server"></asp:Label>
          <br />
          <asp:Button ID="Button7" runat="server" Text="清空入库数据" OnClick="Button7_Click" BackColor="#FFCCCC" />
          &nbsp; &nbsp; &nbsp; &nbsp; 
