<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminExternalTeacher.aspx.cs" Inherits="Admin_AdminSchoolTeacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="top">
    <asp:Label ID="Label1" runat="server" Text="外聘教师页面"></asp:Label></div>
