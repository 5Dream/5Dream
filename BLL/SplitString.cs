...
namespace BLL
{
    public class SplitString
    {
        ...
        {
            List<string> str1 = new List<string>();//第一次拆分
        ...
        public static List<string> SplitTimeAndAreaString(string str)
        {
            ...
            string[] strTemp = str.Split(new char[] { '@' }, StringSplitOptions.RemoveEmptyEntries);//从@拆分字符串
        ...
        {
            List<string> strList = new List<string>();
            if(str.IndexOf("CAD/CAM一体化教室")!=-1) //排除特例
            {
                str = str.Replace("CAD/CAM一体化教室", "CAD与CAM一体化教室");
            }
        ...
        public static string GetWithoutWeek(string str)
        {
            ...
            string[] strTemp = str.Split(new char[] { ',' }, StringSplitOptions.RemoveEmptyEntries); //拆分周次
            for(int i=0;i<strTemp.Length;i++)
            {
